var rubiscoControlGeocoder = (function (exports, L) {
      ...
      this.options = {
        ...
        htmlTemplate: function htmlTemplate(r) {
          ...
          if (address.city || address.town || address.village || address.hamlet) {
            className = parts.length > 0 ? 'maptrix-control-geocoder-address-detail' : '';
            parts.push('<span class="' + className + '">{postcode} {city} {town} {village} {hamlet}</span>');
          }

          if (address.state || address.country) {
            className = parts.length > 0 ? 'maptrix-control-geocoder-address-context' : '';
  ...
  var GeocoderControl = /*#__PURE__*/function (_EventedControl) {
    ...
    _proto.addThrobberClass = function addThrobberClass() {
      L__namespace.DomUtil.addClass(this._container, 'maptrix-control-geocoder-throbber');
    };

    _proto.removeThrobberClass = function removeThrobberClass() {
      L__namespace.DomUtil.removeClass(this._container, 'maptrix-control-geocoder-throbber');
    }
    /**
    ...
    _proto.onAdd = function onAdd(map) {
      ...
      var className = 'maptrix-control-geocoder';
      var container = L__namespace.DomUtil.create('div', className + ' maptrix-bar');
      ...
      this._alts = L__namespace.DomUtil.create('ul', className + '-alternatives maptrix-control-geocoder-alternatives-minimized', container);
    ...
    _proto._geocodeResult = function _geocodeResult(results, suggest) {
      if (!suggest && this.options.showUniqueResult && results.length === 1) {
        ...
        L__namespace.DomUtil.removeClass(this._alts, 'maptrix-control-geocoder-alternatives-minimized');
        L__namespace.DomUtil.addClass(this._container, 'maptrix-control-geocoder-options-open');

        for (var i = 0; i < results.length; i++) {
          this._alts.appendChild(this._createAlt(results[i], i));
        }
      } else {
        L__namespace.DomUtil.addClass(this._container, 'maptrix-control-geocoder-options-error');
        L__namespace.DomUtil.addClass(this._errorElement, 'maptrix-control-geocoder-error');
      }
    }
    /**
    ...
    _proto._toggle = function _toggle() {
      if (L__namespace.DomUtil.hasClass(this._container, 'maptrix-control-geocoder-expanded')) {
        this._collapse();
      } else {
        this._expand();
      }
    ...
    _proto._expand = function _expand() {
      L__namespace.DomUtil.addClass(this._container, 'maptrix-control-geocoder-expanded');
    ...
    _proto._collapse = function _collapse() {
      L__namespace.DomUtil.removeClass(this._container, 'maptrix-control-geocoder-expanded');
      L__namespace.DomUtil.addClass(this._alts, 'maptrix-control-geocoder-alternatives-minimized');
      L__namespace.DomUtil.removeClass(this._errorElement, 'maptrix-control-geocoder-error');
      L__namespace.DomUtil.removeClass(this._container, 'maptrix-control-geocoder-options-open');
      L__namespace.DomUtil.removeClass(this._container, 'maptrix-control-geocoder-options-error');
    ...
    _proto._keydown = function _keydown(e) {
      ...
      var select = function select(dir) {
        if (_this5._selection) {
          L__namespace.DomUtil.removeClass(_this5._selection, 'maptrix-control-geocoder-selected');
        ...
        if (_this5._selection) {
          L__namespace.DomUtil.addClass(_this5._selection, 'maptrix-control-geocoder-selected');
        }
      };
   ...
   * https://github.com/perliedman/maptrix-control-geocoder
   *
