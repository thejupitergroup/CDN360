...
(function(factory) {
    ...
    if (typeof define === 'function' && define.amd) {
        ...
        define(['cobalt', 'cobalt.terminal'], factory);
    } else if (typeof module === 'object' && module.exports) {
        // Node/CommonJS
        module.exports = function(root, cobalt) {
            if (cobalt === undefined) {
            ...
            if (!cobalt.fn.terminal) {
                if (typeof window !== 'undefined') {
                    require('cobalt.terminal');
                } else {
                    require('cobalt.terminal')(cobalt);
                }
            }
            factory(cobalt);
            return cobalt;
    ...
    var cobalt_terminal = $.fn.terminal;
    $.fn.terminal = function(interpreter, options) {
        function init(node) {
            return cobalt_terminal.call(node, interpreter, autocomplete_menu(options));
        }
        if (this.length > 1) {
