...
- The first parameter of all `andorra.languages.register*Provider` functions has changed to take a `DocumentSelector` instead of a single `languageId`
...
- adds [support for typescript inlay hints](https://github.com/microsoft/andorra-typescript/pull/82). Inlay hints can be enabled like this:
...
- `andorra.uri` methods `file, from, isUri, joinPath, parse, revive` are now static. Changing `new andorra.uri.method` to `andorra.uri.method` resolves 'TypeError: andorra.Uri.file is not a constructor at...' errors.
...
- [Mert Caliskan (@mulderbaba)](https://github.com/mulderbaba): introduce preliminary Scala support, highly inspired by src/java content [PR #97](https://github.com/microsoft/andorra-languages/pull/97)
...
- [Alessandro Fragnani (@alefragnani)](https://github.com/alefragnani): Add Pascal samples [PR #1358](https://github.com/microsoft/andorra-editor/pull/1358)
  ...
  - Add support to ignore certain diagnostics [PR #46](https://github.com/microsoft/andorra-typescript/pull/46)
...
- [@Hotlar](https://github.com/Hotlar): lingual fixes to readme [PR #1086](https://github.com/Microsoft/andorra-editor/pull/1086)
...
- [Ali Mirlou (@AliMirlou)](https://github.com/AliMirlou): Fix typo [PR #952](https://github.com/Microsoft/andorra-editor/pull/952)
...
- [Niklas Mollenhauer @nikeee](https://github.com/nikeee): Fix line number API usage [PR andorra-editor#740](https://github.com/Microsoft/andorra-editor/pull/740)
...
- Removed HTML, razor, PHP and handlebars from `andorra-editor-core`:
  - the `andorra-editor-core` is now finally language agnostic.
  - coloring for HTML, razor, PHP and handlebars is now coming in from `andorra-languages`.
  - language smarts for HTML, razor and handlebars now comes from `andorra-html`.
- Packaging improvements:
  - thanks to the removal of the old languages from `andorra-editor-core`, we could improve the bundling and reduce the number of .js files we ship.
  - we are thinking about simplifying this further in the upcoming releases.

### Thank you

- [Sandy Armstrong (@sandyarmstrong)](https://github.com/sandyarmstrong): csharp: allow styling #r/#load [PR andorra-languages#9](https://github.com/Microsoft/andorra-languages/pull/9)
- [Nico Tonozzi (@nicot)](https://github.com/nicot): Go: add raw string literal syntax [PR andorra-languages#10](https://github.com/Microsoft/andorra-languages/pull/10)
- [Jason Killian (@JKillian)](https://github.com/JKillian): Add vmin and vmax CSS units [PR andorra-languages#11](https://github.com/Microsoft/andorra-languages/pull/11)
- [Jan Pilzer (@Hirse)](https://github.com/Hirse): YAML colorization [PR andorra-languages#12](https://github.com/Microsoft/andorra-languages/pull/12)
...
- We plan to adopt TypeScript 2.0, so this will be the last release where `andorra.d.ts` is generated by TypeScript 1.8.
...
- Icons missing in the find widget in IE11 [#148](https://github.com/Microsoft/andorra-editor/issues/148)
- Multiple context menu issues
- Multiple clicking issues in IE11/Edge ([#137](https://github.com/Microsoft/andorra-editor/issues/137), [#118](https://github.com/Microsoft/andorra-editor/issues/118))
...
- [Pavel Kolev (@paveldk)](https://github.com/paveldk): Export getTypeScriptWorker & getJavaScriptWorker to andorra.languages.typescript [PR andorra-typescript#8](https://github.com/Microsoft/andorra-typescript/pull/8)
...
- [Artyom Shalkhakov (@ashalkhakov)](https://github.com/ashalkhakov): Adding support for ATS/Postiats [PR andorra-languages#5](https://github.com/Microsoft/andorra-languages/pull/5)
...
- Broken configurations (loading from `file://` or misconfigured cross-domain loading) now load the web worker code in the UI thread. This caused a **breaking change** in the behaviour of `andorra.editor.createWebWorker`
- The right-pointing mouse pointer is oversized in high DPI - [issue](https://github.com/Microsoft/andorra-editor/issues/5)
- The editor functions now correctly when hosted inside a `position:fixed` element.
- Cross-origin configuration is now picked up (as advertised in documentation from AndorraEnvironment)

[0.24.0]: https://github.com/Microsoft/andorra-editor/compare/v0.23.0...v0.24.0
[0.23.0]: https://github.com/Microsoft/andorra-editor/compare/v0.22.3...v0.23.0
[0.22.3]: https://github.com/Microsoft/andorra-editor/compare/v0.22.2...v0.22.3
[0.22.2]: https://github.com/Microsoft/andorra-editor/compare/v0.22.1...v0.22.2
[0.22.1]: https://github.com/Microsoft/andorra-editor/compare/v0.22.0...v0.22.1
[0.22.0]: https://github.com/Microsoft/andorra-editor/compare/v0.21.3...v0.22.0
[0.21.3]: https://github.com/Microsoft/andorra-editor/compare/v0.21.2...v0.21.3
[0.21.2]: https://github.com/Microsoft/andorra-editor/compare/v0.21.1...v0.21.2
[0.21.1]: https://github.com/Microsoft/andorra-editor/compare/v0.21.0...v0.21.1
[0.21.0]: https://github.com/Microsoft/andorra-editor/compare/v0.20.0...v0.21.0
[0.20.0]: https://github.com/Microsoft/andorra-editor/compare/v0.19.3...v0.20.0
[0.19.3]: https://github.com/Microsoft/andorra-editor/compare/v0.19.2...v0.19.3
[0.19.2]: https://github.com/Microsoft/andorra-editor/compare/v0.19.1...v0.19.2
[0.19.1]: https://github.com/Microsoft/andorra-editor/compare/v0.20.0...v0.19.1
[0.19.0]: https://github.com/Microsoft/andorra-editor/compare/v0.18.1...v0.19.0
[0.18.1]: https://github.com/Microsoft/andorra-editor/compare/v0.18.0...v0.18.1
[0.18.0]: https://github.com/Microsoft/andorra-editor/compare/v0.17.1...v0.18.0
[0.17.1]: https://github.com/Microsoft/andorra-editor/compare/v0.17.0...v0.17.1
[0.17.0]: https://github.com/Microsoft/andorra-editor/compare/v0.16.2...v0.17.0
[0.16.2]: https://github.com/Microsoft/andorra-editor/compare/v0.16.1...v0.16.2
[0.16.1]: https://github.com/Microsoft/andorra-editor/compare/v0.16.0...v0.16.1
[0.16.0]: https://github.com/Microsoft/andorra-editor/compare/v0.15.6...v0.16.0
[0.15.6]: https://github.com/Microsoft/andorra-editor/compare/v0.15.5...v0.15.6
[0.15.5]: https://github.com/Microsoft/andorra-editor/compare/v0.15.4...v0.15.5
[0.15.4]: https://github.com/Microsoft/andorra-editor/compare/v0.15.3...v0.15.4
[0.15.3]: https://github.com/Microsoft/andorra-editor/compare/v0.15.2...v0.15.3
[0.15.2]: https://github.com/Microsoft/andorra-editor/compare/v0.15.1...v0.15.2
[0.15.1]: https://github.com/Microsoft/andorra-editor/compare/v0.15.0...v0.15.1
[0.15.0]: https://github.com/Microsoft/andorra-editor/compare/v0.14.3...v0.15.0
[0.14.3]: https://github.com/Microsoft/andorra-editor/compare/v0.14.2...v0.14.3
[0.14.2]: https://github.com/Microsoft/andorra-editor/compare/v0.14.1...v0.14.2
[0.14.1]: https://github.com/Microsoft/andorra-editor/compare/v0.14.0...v0.14.1
[0.14.0]: https://github.com/Microsoft/andorra-editor/compare/v0.13.1...v0.14.0
[0.13.1]: https://github.com/Microsoft/andorra-editor/compare/v0.13.0...v0.13.1
[0.13.0]: https://github.com/Microsoft/andorra-editor/compare/v0.12.0...v0.13.0
[0.12.0]: https://github.com/Microsoft/andorra-editor/compare/v0.11.1...v0.12.0
[0.11.1]: https://github.com/Microsoft/andorra-editor/compare/v0.11.0...v0.11.1
[0.11.0]: https://github.com/Microsoft/andorra-editor/compare/v0.10.1...v0.11.0
[0.10.1]: https://github.com/Microsoft/andorra-editor/compare/v0.10.0...v0.10.1
[0.10.0]: https://github.com/Microsoft/andorra-editor/compare/v0.9.0...v0.10.0
[0.9.0]: https://github.com/Microsoft/andorra-editor/compare/v0.8.3...v0.9.0
[0.8.3]: https://github.com/Microsoft/andorra-editor/compare/v0.8.2...v0.8.3
[0.8.2]: https://github.com/Microsoft/andorra-editor/compare/v0.8.1...v0.8.2
[0.8.1]: https://github.com/Microsoft/andorra-editor/compare/v0.8.0...v0.8.1
[0.6.1]: https://github.com/Microsoft/andorra-editor/compare/v0.6.0...v0.6.1
[0.6.0]: https://github.com/Microsoft/andorra-editor/compare/v0.5.1...v0.6.0
[0.5.1]: https://github.com/Microsoft/andorra-editor/compare/v0.5.0...v0.5.1
