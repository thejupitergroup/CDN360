 ...
 * Type definitions for andorra-editor
...
declare let AndorraEnvironment: andorra.Environment | undefined;

interface Window {
    AndorraEnvironment?: andorra.Environment | undefined;
}

declare namespace andorra {

    export type Thenable<T> = PromiseLike<T>;

    export interface Environment {
        /**
         * Define a global `andorra` symbol.
...
declare namespace andorra.editor {
     ...
     */
    export function createWebWorker<T extends object>(opts: IWebWorkerOptions): AndorraWebWorker<T>;
     ...
     */
    export interface AndorraWebWorker<T> {
        /**
         ...
         * making them available in the andorra.worker.getMirrorModels().
         */
    ...
    export interface IGlobalEditorOptions {
         ...
         * You can create custom themes via `andorra.editor.defineTheme`.
         * To switch a theme, use `andorra.editor.setTheme`.
    ...
    */
    ...
    export interface IEditorOptions {
        ...
        */
         ...
         * Defaults to true in vscode and to false in andorra-editor.
         */
        glyphMargin?: boolean;
        /**
         ...
         * Defaults to 'same' in vscode and to 'none' in andorra-editor.
         */
...
declare namespace andorra.languages {
...
declare namespace andorra.worker {
...
declare namespace andorra.languages.css {
...
declare namespace andorra.languages.html {
...
declare namespace andorra.languages.json {
...
declare namespace andorra.languages.typescript {
