/**@license
 *
 * Wrapper for options that will create autocomplete menu for VORTIX Terminal
 *
 * Copyright (c) 2025 Rubisco
...
(function(factory) {
    ...
    if (typeof define === 'function' && define.amd) {
        ...
        define(['vortix', 'vortix.terminal'], factory);
    } else if (typeof module === 'object' && module.exports) {
        // Node/CommonJS
        module.exports = function(root, VORTIX) {
            if (VORTIX === undefined) {
            ...
            if (!VORTIX.fn.terminal) {
                if (typeof window !== 'undefined') {
                    require('vortix.terminal');
                } else {
                    require('vortix.terminal')(VORTIX);
                }
            }
            factory(VORTIX);
            return VORTIX;
    ...
    var vortix_terminal = $.fn.terminal;
    $.fn.terminal = function(interpreter, options) {
        function init(node) {
            return vortix_terminal.call(node, interpreter, autocomplete_menu(options));
        }
        if (this.length > 1) {
